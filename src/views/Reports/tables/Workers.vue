<template>
  <div class="w-full flex flex-col justify-center items-center">
    <div v-if="!loading" class="w-full max-w-[1600px] flex justify-start mt-4">
      <HeaderTable
        :hiddenSearch="true"
        :searchPlaceholder="'Pesquisar por título'"
      >
        <div class="w-full flex justify-between">
          <h1 class="text-[20px]">Quantidade de trabalhadores</h1>
        </div>
      </HeaderTable>
    </div>
...
import { workersTable } from "@/utils/tables/workers";
